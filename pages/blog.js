...
export default class extends React.Component {
    ...
    render() {
        for(var i = 0; i < 26; i++){
            this.state.blogPages.push(<div key={i} className="flex-row"><a style={{lineHeight: "50px"}} href={"/" + i} key={i}>{i}</a></div>) 
        }
        return (
            <div>
                <Style />
                        ...
                        <div className="flex-blog">
                            <div style={{borderLeft: "1px dashed white", borderRight: "1px dashed white", width: "20em"}}>
                                    <div className="flex-row">
                                        <a onClick={this.handleClickInternal} style={{lineHeight: "50px"}} href="/blog/page" >Hello World</a>
                                    </div>
